...
const CARD_DETAILS = [
  { 
    ...
    number: 'JAVA SWING • MYSQL • JDBC', 
    cvv: '01',
    github: 'https://github.com/SarthakDudhe/CabBookingSystem',
    live: 'https://github.com/SarthakDudhe/CabBookingSystem',
    image: cbs
  },
  { 
    name: 'PREPGENIE INTERVIEW PREP', 
    number: 'REACT • MONGO • TAILWIND • NODE', 
    cvv: '02',
    github: 'https://github.com/SarthakDudhe/PrepGenie',
    live: 'https://prep-genie-k3cd.vercel.app/',
    image: prepgenie
  },
  { 
    name: 'QUICKCHAT APPLICATION', 
    number: 'SOCKET.IO • REACT • EXPRESS • NODE', 
    cvv: '03',
    github: 'https://github.com/SarthakDudhe/ChatApplication',
    live: 'https://chat-application-eight-wine.vercel.app/login',
    image: chat
  },
  { 
    name: 'PORTFOLIO SITE', 
    number: 'REACT • VITE • TAILWIND • SPLINE', 
    cvv: '04',
    github: 'https://github.com/SarthakDudhe/Portfolio-Sarthak',
    live: 'https://github.com/SarthakDudhe/Portfolio-Sarthak',
    image: null
  },
  { 
    name: 'ML PREDICTIVE ENGINE', 
    number: 'PYTHON • JUPYTER • SCIKIT-LEARN', 
    cvv: '05',
    github: 'https://github.com/SarthakDudhe',
    live: 'https://github.com/SarthakDudhe',
    image: null
  }
];
...
const Project = () => {
  ...
  const renderLoop = () => {
    ...
    for (let i = 0; i < cardCount; i++) {
      ...
      // Allow cards to render completely off-screen smoothly up to offset 3.0
      if (absOffset > 3.0) {
      ...
      const gap = 36;
      const peekAmount = -55; // Push the card's edge 55px past the screen boundary
  ...
  return (
    <section className="projects-section relative w-full bg-black text-white flex flex-col items-center justify-center overflow-hidden select-none" id="projects">
      <div className="projects-header z-20">
        <h1>Projects</h1>
      ...
      <div
        className="relative w-full h-[65vh] min-h-[450px] flex items-center justify-center pointer-events-none mt-10"
        style={{
          perspective: '1350px',
        }}
      >
              ...
              {thicknessLayers.map((zOffset, layerIdx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 p-5 sm:p-6 text-white h-full w-full font-sans z-10 bg-black/15">
                        ...
                        {/* Project Title / Name */}
                        <div className="absolute left-5 sm:left-6 bottom-5 sm:bottom-6 font-mono text-[9px] sm:text-[11px] tracking-widest text-white/95 font-bold select-none uppercase">
                          {details.name}
                        </div>
                ...
                if (isBackFace) {
                  ...
                  return (
                    <div
                      key={layerIdx}
                      className={`absolute inset-0 rounded-[16px] ${backBorderStyle} overflow-hidden bg-black/85`}
                      style={{
                    ...
                    >
                      ...
                      {/* Subtle project logo on back face */}
                      {details.image && (
                        <div className="absolute right-4 sm:right-6 top-14 sm:top-16 z-20 opacity-20">
                          <img
                            src={details.image}
                            alt=""
                      ...
                      {/* Clickable links */}
                      <div className="absolute right-4 sm:right-6 bottom-4 sm:bottom-5 z-30 flex gap-3 pointer-events-auto">
                        <a
                          href={details.live}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[9px] sm:text-[11px] font-mono font-bold text-blue-400 hover:text-blue-300 transition-colors cursor-pointer"
                        >
                          LIVE
                        </a>
                        <a
